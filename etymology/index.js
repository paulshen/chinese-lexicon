...
simp("满", "滿");
phonsem("鳳", "凡", "鳥", 3, "phoenix", "Originally a pictograph of a mythical Chinese bird, similar to a phoenix. Later the phonetic component 凡 was added.", false, false, "obs");
simp("凤", "鳳", [[2], [0, 2]], {}, { 鳥: "又" });
icon("風", "wind", "Originally written the same as 鳳 (phoenix) because the two characters sounded the same. Later the bottom part of the character was abbreviated to distinguish the two characters.", "os", [soundComponent("凡", [0, 3]), iconComponent("鳳", [3], "Abbreviated remnant of 鳳, originally a pictograph of a mythical bird. Later reanalyzed as 虫 (bug, worm).")]);
simp("风", "風", [[0, 2], [2]], {}, { 鳳: "㐅" });
